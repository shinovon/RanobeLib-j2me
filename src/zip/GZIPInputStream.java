...
public class GZIPInputStream extends InflaterInputStream {
	 ...
	 *
	 * @throws IOException              if an error occurs during an I/O operation.
	 * @throws IllegalArgumentException if <code>size</code> is less than or equal
	 *                                  to 0.
	 */
	 ...
	 * array of bytes. The method will block until either enough input data becomes
	 * available or the compressed stream reaches its end.
	 *
	 * @param buf    the buffer into which the uncompressed data will be stored.
	 * @param offset the offset indicating where in <code>buf</code> the
	...
	public int read(byte[] buf, int offset, int len) throws IOException {
		...
		// System.err.println("GZIPIS.read(byte[], off, len ... " + offset + " and len "
		// + len);
